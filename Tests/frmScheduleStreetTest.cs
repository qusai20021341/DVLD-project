...
namespace DVLD_project
{
    ...
    public partial class frmScheduleStreetTest : Form
    {
        ...
        public frmScheduleStreetTest(clsAppointment Appointment)
        {
            InitializeComponent();
        ...
        private void LoadAppointmentData()
        {
            ...
            int TestTypeID = clsTestType.GetTestTypeIDByTestTypeTitle("Practical (Street) Test");
            lblTrail.Text = clsAppointment.NumberOfTrails(_Appointment.LDLAppID, TestTypeID).ToString();

            clsTestType testType = clsTestType.GetTestTypeByTestTypeTitle("Practical (Street) Test");
            decimal testFees = 0;
            if (testType != null)
            {
        ...
        private void btnSave_Click(object sender, EventArgs e)
        {
            ...
            {
                _Appointment.TestTypeID = clsTestType.GetTestTypeIDByTestTypeTitle("Practical (Street) Test");
                _Appointment.LDLAppID = LDLApp.LocalDrivingLicenseApplicationID;
                _Appointment.AppointmentDate = dtpAppointmentDate.Value;
                _Appointment.PaidFees = clsTestType.GetTestTypeByTestTypeTitle("Practical (Street) Test").TestTypeFees;
